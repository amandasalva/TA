...
class BendaharaPendaftaranSiswa extends Controller
{
    ...
    public function index()
    {
        ...
        $nis = str_pad(($LastNIS ? $LastNIS + 1 : 1792), 4, '0', STR_PAD_LEFT);
        ...
        return view('u_bendahara.pendaftaran.daftar-siswa', compact('nis', 'tapel', 'username', 'siswa'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        // $kelas = Kelas::where('tingkat', 1)->first();
