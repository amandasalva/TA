              ...
              <tbody>
                ...
                <tr style="text-align: center">
                  ...
                  <td>
                      ...
                      <img src="{{ asset('images/user-default.jpg' .$dtguru->image) }}" alt="Foto guru" class="w-px-40 h-auto rounded-circle" />                              
                      @else
                  ...
                  <td>
                    <form action="{{ route('bendahara.hapus.data', $dtguru->id) }}" method="POST">
                      ...
                      data-bs-toggle="modal" data-bs-target="#modal-detail{{ $dtguru->id }}" style="padding: 7px"><i class='bx bxs-door-open'></i></button>
                      ...
                      <button type="submit" style="padding: 7px; margin-right: 10px;" onclick="deleteUser(this)" data-id="{{ $dtguru->id }}" class="btn btn-danger"><i class='bx bx-trash'></i></button>
                    </form>
                  </td>
                </tr>
                <div class="modal fade" id="modal-detail{{ $dtguru->id }}" tabindex="-1" aria-hidden="true">
                      ...
                      <div class="modal-body">
                        <div class="row g-2 mb-2">
                          <div class="col mb-0">
                            ...
                            <input type="text" id="nama_lengkap" class="form-control" value="{{ $dtguru->nama_lengkap }}">
                          </div>
                          <div class="col mb-0">
                            <label for="username" class="form-label">Username</label>
                            <input type="text" id="username" class="form-control" value="{{ $dtguru->username }}">
                          </div>
                        </div>
                        <div class="row g-2 mb-2">
                          <div class="col mb-0">
                            <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                            <input type="text" id="tempat_lahir" class="form-control" value="{{ $dtguru->tempat_lahir }}">
                          </div>
                          <div class="col mb-0">
                            <label for="tgl_lahir" class="form-label">Tanggal Lahir</label>
                            <input type="text" id="tgl_lahir" class="form-control" value="{{ \Carbon\Carbon::parse($dtguru->tgl_lahir)->locale('id')->translatedFormat('d/m/Y') }}">
                          </div>
                        </div>
                        <div class="row g-2 mb-2">
                          <div class="col mb-0">
                            <label for="jk" class="form-label">Jenis Kelamin</label>
                            <input type="text" id="jk" class="form-control" value="{{ $dtguru->jk }}">
                          </div>
                            <div class="col mb-0">
                              <label for="agama" class="form-label">Agama</label>
                              <input type="text" id="agama" class="form-control" value="{{ $dtguru->agama }}">
                            </div>
                          </div>
                          <div class="row g-2 mb-2">
                            <div class="col mb-0">
                              <label for="no_hp" class="form-label">No hp</label>
                              <input type="text" id="no_hp" class="form-control" value="{{ $dtguru->no_hp }}">
                            </div>
                            <div class="col mb-0">
                              <label for="status" class="form-label">Status</label>
                              <input type="text" id="status" class="form-control" value="{{ $dtguru->status }}">
                            </div>
                        ...
                        <div class="row mb-2">
                          <div class="col mb-0">
                            ...
                            <input type="text" id="alamat" class="form-control" value="{{ $dtguru->alamat }}">
                          </div>
                        </div>
                        {{-- <div class="row">
                          <div class="col mb-0">
