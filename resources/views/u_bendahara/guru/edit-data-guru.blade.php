@extends('layout.main', ['title' => 'Edit Data Guru - Bendahara', 'foto_profil' => $data->image, 'active' => 'data-guru'])
        ...
        <div class="col-xxl">
          <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
              <h4 class="mb-3">Edit Data Guru</h4>
            </div>
            <div class="card-body">
              <form action="{{ route('bendahara.update.guru', $guru->id) }}" method="POST" >
                @csrf
                @method('PUT')
                <div class="row mb-3">
