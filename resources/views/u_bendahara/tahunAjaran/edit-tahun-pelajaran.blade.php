        ...
        <div class="col-xxl">
          <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
              <h4 class="mb-3">Edit Data Tahun Pelajaran</h4>
            </div>
            <div class="card-body">
              <form action="{{ route('bendahara.update.tahun.pelajaran', $tahunAjaran->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    @error('tahun')
                      is-invalid
                    @enderror" id="tahun" name="tahun" value="{{ $tahunAjaran->tahun }}" placeholder="2020/2021" autocomplete="off"/>
                    @error('tahun')
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-md-10">
                    <div class="form-check form-check-inline">
                      ...
                      @error('semester')
                        is-invalid
                      @enderror" type="radio" value="ganjil" {{ ($tahunAjaran->semester == "ganjil")? "checked" : "" }}>
                    ...
                    <div class="form-check form-check-inline">
                      ...
                      @error('semester')
                        is-invalid
                      @enderror" type="radio" value="genap" {{ ($tahunAjaran->semester == "genap")? "checked" : "" }}>
