            ...
            <div class="row">
                <div class="col-xxl">
                    ...
                    @error('tahun')
                      is-invalid
                    @enderror"
                                            id="tahun" name="tahun" value="{{ $tahunAjaran->tahun }}"
                                            placeholder="2020/2021" autocomplete="off" />
                                        @error('tahun')
                      ...
                      @enderror"
                                                ...
                                                @if ($tahunAjaran->semester == 'Ganjil') checked @endif>
                      ...
                      @enderror"
                                                ...
                                                @if ($tahunAjaran->semester == 'Genap') checked @endif>
