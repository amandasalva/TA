                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center">
                            <h4 class="mb-3">Formulir Pendaftaran Siswa Tahun Ajaran Baru</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('bendahara.tambah.pendaftar') }}" method="POST"
                  ...
                  <div class="col-sm-10">
                    ...
                    @error('username')
                      is-invalid
                    @enderror" id="username" name="username" value="{{ $nis }}" autocomplete="off"/>
                    @error('username')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
