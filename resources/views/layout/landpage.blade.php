        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          ...
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-start">
              <a href="{{ route('siswa.login') }}" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                <span>MASUK</span>
        ...
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              ...
              <h2>SD Muhammadiyah 05 Karangtalun</h2>
              <p style="text-align: justify">
                Sekolah Dasar (SD) Muhammadiyah 05 Karangtalun adalah salah satu sekolah swasta yang berdiri sejak 01 September 1960 di Kabupaten Cilacap.
                SD Muhammadiyah 05 ini sudah terakreditasi B dengan pembelajaran menggunakan kurikulum 2013 dan kurikulum merdeka,
                serta kegiatan belajar mengajar selama 6 hari dalam seminggu.
              </p>
            </div>
          </div>
    ...
    <section id="visimisi" class="services">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>Visi & Misi</h2>
          <p>Visi & Misi SD Muhammadiyah 05</p>
        </header>
